    ...
    <div class="col-12 col-sm-12 col-md-12">
        <div class="card card-dark">
            <div class="card-header border-transparent">
                <h3 class="card-title pt-1">Detail Bidang Studi </h3>
                <div class="card-tools">
                    <a href="{{ route('dataBidangStudi.index') }}" class="btn btn-sm btn-secondary float-right">
            ...
            <form id="form_bidang_studi">
                ...
                <div class="col-sm-6">
                    ...
                    <x-adminlte-input name="created_at" type="text" value="{{ $data_bidang_studi->created_at }}" label="Waktu Ditambahkan" fgroup-class="col-md-12" disabled>
                    ...
                    <x-adminlte-input name="updated_at" type="text" value="{{ $data_bidang_studi->updated_at }}" label="Waktu Diperbaharui" fgroup-class="col-md-12" disabled>
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-gradient-green">
                                <i class="fas fa-calendar-alt"></i>
                            </div>
        ...
        <div class="card-footer">
            <x-adminlte-button id="edit" class="btn bg-gradient-green edit" label="Edit Data"icon="fas fa fa-fw fa-edit" />
            <x-adminlte-button id="simpan" class="btn bg-gradient-green simpan" type="submit"label="Simpan Data" icon="fas fa fa-fw fa-save" />
            <x-adminlte-button id="batal" class="btn bg-gradient-maroon cancel" label="Batal"icon="fas fa fa-fw fa-times" />
        </div>
    </form>
</div>
</div>
