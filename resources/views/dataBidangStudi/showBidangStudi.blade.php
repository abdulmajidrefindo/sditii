                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <x-adminlte-input name="created_at" type="text" value="{{ $data_bidang_studi->created_at }}"
                            ...
                            <x-adminlte-input name="updated_at" type="text" value="{{ $data_bidang_studi->updated_at }}"
