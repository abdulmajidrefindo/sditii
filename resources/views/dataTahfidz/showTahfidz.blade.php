...
@section('content_header')
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">{{ $data_tahfidz->nama_nilai }}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                {{ Breadcrumbs::render('dataTahfidz.show', $data_tahfidz) }}
            </ol>
        </div>
    </div>
        ...
        <div class="col-12 col-sm-12 col-md-12">
            <div class="card card-dark">
                <div class="card-header border-transparent">
                    <h3 class="card-title pt-1">Detail Tahfidz </h3>
                    <div class="card-tools">
                        <a href="{{ route('dataTahfidz.index') }}" class="btn btn-sm btn-secondary float-right">
                    ...
                    <div class="row">
                        <div class="col-sm-6 border-right">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="input-group">
                                        <input id="periode" name="periode" value="{{ $data_tahfidz->periode->semester == 1 ? 'Ganjil' : 'Genap' }} - {{ $data_tahfidz->periode->tahun_ajaran }}"
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="input-group">
                                        <input id="nama_nilai" name="nama_nilai" value="{{ $data_tahfidz->nama_nilai }}"
                                            class="form-control" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="custom-select" name="kelas_id"
                                        ...
                                        @foreach ($data_kelas as $k)
                                            <option value={{ $k->id }} {{ $k->id == $data_tahfidz->kelas_id ? 'selected' : '' }}>
                                                {{ $k->nama_kelas }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="custom-select" name="guru_id"
                                        ...
                                        @foreach ($data_guru as $g)
                                            <option value={{ $g->id }} {{ $g->id == $data_tahfidz->guru_id ? 'selected' : '' }}>
                                                {{ $g->nama_guru }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input id="id" name="id" value="{{ $data_tahfidz->id }}"
                                        class="form-control" disabled>
                                </div>
                            </div>

                            <x-adminlte-input name="created_at" type="text" value="{{ $data_tahfidz->created_at }}"
                            ...
                            <x-adminlte-input name="updated_at" type="text" value="{{ $data_tahfidz->updated_at }}"
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            $('#form_tahfidz').on('submit', function(e) {
                e.preventDefault();
                var $form = $(this); 
                $('#edit').show();
                $('#simpan').hide();
                ...
                $.ajax({
                    url: "{{ route('dataTahfidz.update', $data_tahfidz->id) }}",
                    type: "PUT",
                    data: {
                    ...
                    error: function(err) {
                        if (err.status == 422) {
                            $('#form_tahfidz').find('.is-invalid').removeClass(
                                'is-invalid');
                            $('#form_tahfidz').find('.error').remove();
