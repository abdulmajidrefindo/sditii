...
@section('content_header')
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Nilai {{ $siswaTahfidz[0]->siswa->nama_siswa }}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                {{ Breadcrumbs::render('siswaTahfidz.show', $siswaTahfidz[0]) }}
            </ol>
        </div>
    </div>
            ...
            <div class="card card-dark">
                <div class="card-header border-transparent">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('siswaTahfidz.index') }}" class="btn btn-sm btn-secondary float-right">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input id="kelas" name="kelas" value="{{ $siswaTahfidz[0]->siswa->sub_kelas->kelas->nama_kelas }} {{ $siswaTahfidz[0]->siswa->sub_kelas->nama_sub_kelas }}"
                                        class="form-control" disabled>
                                </div>
                            </div>
