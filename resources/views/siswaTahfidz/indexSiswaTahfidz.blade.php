        ...
        <div class="row">
                        ...
                        <ul class="nav nav-tabs" id="tahfidzTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                ...
                                <li class="nav-item" role="presentation" hidden>
                                    ...
                                    aria-controls="content-tambah-tahfidz-add" aria-selected="false">Tambah Penilaian</a>
                                </li>
                                <li class="nav-item" role="presentation" hidden>
                                    <a class="nav-link" id="controller-tab-tahfidz-add" data-toggle="tab"
                                    href="#content-tab-tahfidz-add" role="tab"
                                    aria-controls="content-tab-tahfidz-add" aria-selected="false">Ubah Penilaian</a>
                                </li>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @endforeach
                                                <td>
                                                    <a href="{{ route('siswaTahfidz.show', encrypt($siswa['siswa_id'])) }}"
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header bg-gradient-green">
                                <h3 class="card-title">Ekspor Data Tahfidz</h3>
                            </div>
                            <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header bg-gradient-green">
                            <h3 class="card-title">Impor Data Tahfidz</h3>
                        </div>
                        <div class="card-body">
