                        ...
                        <ul class="nav nav-tabs" id="doaTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                ...
                                <li class="nav-item" role="presentation">
                                    ...
                                    aria-controls="content-tab-doa-export-import" aria-selected="false"><i class="fas fa-m fa-folder-open fa-fw"></i>Ekspor/Impor Nilai</a>
                                </li>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @endforeach
                                                <td>
                                                    <a href="{{ route('siswaDoa.show', encrypt($siswa['siswa_id'])) }}"
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header bg-gradient-green">
                                <h3 class="card-title">Ekspor Data Doa</h3>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header bg-gradient-green">
                                <h3 class="card-title">Impor Data Doa</h3>
                            </div>
                            <div class="card-body">
