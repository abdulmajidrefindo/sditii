          ...
          <tr class="odd">
            <div class="form-group col-md-12">
              ...
              <div class="input-group">
                  <input id="id" name="id" value="{{ $user }}" class="form-control"
                      disabled>
              </div>
          </div>
          </tr><tr class="even">
