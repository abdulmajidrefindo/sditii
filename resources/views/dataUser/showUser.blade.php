    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                {{ Breadcrumbs::render('dataUser.show', $user) }}
            </ol>
        </div>
    </div>
        ...
        <div class="col-12 col-sm-12 col-md-12">
            <div class="card card-dark">
                <div class="card-header border-transparent">
                    <h3 class="card-title pt-1">Detail User </h3>
                    <div class="card-tools">
                        <!-- button to edit page-->

                        <a href="{{ route('dataUser.index') }}" class="btn btn-sm btn-secondary float-right">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input id="name" name="name" value="{{ $user->name }}" class="form-control"
                                        disabled>
                                </div>
                            </div>
                ...
                <div class="card-footer">
                    <x-adminlte-button id="simpan" class="btn bg-gradient-green simpan" type="submit" label="Simpan Data"
                        icon="fas fa fa-fw fa-save" hidden />

                    <x-adminlte-button id="edit" class="btn bg-gradient-green edit" type="submit" label="Edit Data"
