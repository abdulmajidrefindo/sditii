...
@section('content_header')
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">{{ $data_doa->nama_nilai }}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                {{ Breadcrumbs::render('dataDoa.show', $data_doa) }}
            </ol>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 border-right">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="input-group">
                                        <input id="periode" name="periode" value="{{ $data_doa->periode->semester == 1 ? 'Ganjil' : 'Genap' }} - {{ $data_doa->periode->tahun_ajaran }}"
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="input-group">
                                        <input id="nama_nilai" name="nama_nilai" value="{{ $data_doa->nama_nilai }}"
                                            class="form-control" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="custom-select" name="kelas_id"
                                        ...
                                        @foreach ($data_kelas as $k)
                                            <option value={{ $k->id }} {{ $k->id == $data_doa->kelas_id ? 'selected' : '' }}>
                                                {{ $k->nama_kelas }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="custom-select" name="guru_id"
                                        ...
                                        @foreach ($data_guru as $g)
                                            <option value={{ $g->id }} {{ $g->id == $data_doa->guru_id ? 'selected' : '' }}>
                                                {{ $g->nama_guru }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input id="id" name="id" value="{{ $data_doa->id }}"
                                        class="form-control" disabled>
                                </div>
                            </div>

                            <x-adminlte-input name="created_at" type="text" value="{{ $data_doa->created_at }}"
                            ...
                            <x-adminlte-input name="updated_at" type="text" value="{{ $data_doa->updated_at }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form_doa').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('dataDoa.update', $data_doa->id) }}",
                    type: "PUT",
                    data: {
                    ...
                    error: function(err) {
                        if (err.status == 422) {
                            $('#form_doa').find('.is-invalid').removeClass(
                                'is-invalid');
                            $('#form_doa').find('.error').remove();
            ...
            $('#edit').click(function() {
                ...
                $('#simpan').show();
                $('#batal').show();
                $('input:not(#id, #periode, #updated_at, #created_at)').prop('disabled', false);
                $('select').prop('disabled', false);
