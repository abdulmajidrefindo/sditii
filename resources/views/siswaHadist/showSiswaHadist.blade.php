            ...
            <div class="card card-dark">
                <div class="card-header border-transparent">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('siswaHadist.index') }}" class="btn btn-sm btn-secondary float-right">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input id="kelas" name="kelas" value="{{ $siswaHadist[0]->siswa->sub_kelas->kelas->nama_kelas }} {{ $siswaHadist[0]->siswa->sub_kelas->nama_sub_kelas }}"
                                        class="form-control" disabled>
                                </div>
                            </div>
