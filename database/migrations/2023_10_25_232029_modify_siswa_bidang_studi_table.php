...
return new class extends Migration
{
    ...
    public function down()
    {
        ...
        Schema::table('siswa_bidang_studis', function (Blueprint $table) {
            $table->dropForeign(['nilai_uh_1']);
            $table->dropForeign(['nilai_uh_2']);
            $table->dropForeign(['nilai_uh_3']);
            $table->dropForeign(['nilai_uh_4']);

            $table->dropForeign(['nilai_tugas_1']);
            $table->dropForeign(['nilai_tugas_2']);

            $table->dropForeign(['nilai_uts']);
            $table->dropForeign(['nilai_pas']);
        });
    }
};
